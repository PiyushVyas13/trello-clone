        ...
        </p>
            {
                isEditing ? 
                    <form action={onSubmit} ref={formRef} className="space-y-2">
                        <FormTextarea id="description" errors={fieldErrors} className="w-full mt-2" placholder="Add a more detailed description" ref={textareaRef} defaultValue={data.description || undefined}/>
